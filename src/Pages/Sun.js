...
export default class Sun extends Component {
  ...
  CalculConsoAnnuel() {
    ...
    PPV = surface_panneau * moyIrra * coeff * 0.22 * 365;
    co2 = (PPV * 43.9) / 1000;
    ...
    if (
      ...
      this.setState({
        Texte1: "Veuillez rentrer toutes les informations nécessaires.",
      });
    } else {
      this.setState({ Prix: PPV });
      ...
      this.setState({ Texte1: "Vous aurez besoin de " });
      this.setState({
        Texte2:
          " panneaux photovoltaïques pour assurer la totalité de votre consomation électrique annuelle, avec votre surface disponible.",
      });
      this.setState({
        Texte3: "Cette simulation vous couterait en panneaux solaires : ",
      });
      this.setState({ Texte4: " euros." });
      this.setState({
        Texte5:
          "L'émission de CO2 totale sur un an de votre installation est d'environ ",
      });
      this.setState({ Texte6: " Kg." });
      this.setState({ Texte7: "Votre LCOE est de " });
    ...
    while (PPV <= parseFloat(this.state.Conso)) {
      if (surface_panneau >= parseFloat(this.state.Surface)) {
        ...
        this.setState({
          Texte2: "% de votre consomation électrique annuelle. Soit ",
        });
        this.setState({
          Texte3: "Cette simulation vous couterait en panneaux solaires: ",
        });
        ...
        this.setState({
          Texte5:
            "L'émission de CO2 totale de votre installation est d'environ ",
        });
        this.setState({ Texte6: " Kg." });
        this.setState({ Texte7: "Votre LCOE est de " });
        this.setState({ Texte8: "€/kWh" });
    ...
    return (
      <div className="element-simu">
        ...
        <div className="header-simu">
          Rentrez vos irradiations par mois (en Wh/m2) :
        </div>
        ...
        <div className="vent">
          ...
          <div className="form-conso">
            <label htmlFor="Conso">
              Rentrez votre consomation électrique sur un an (en W/h) :
            </label>
            <input
              type="number"
              className="form2"
          ...
          <div className="form-conso">
            <label htmlFor="Conso">
              Veuillez rentrer le facteur de correction correspondant à <br />{" "}
              votre oriantation et inclinaison de panneau (sans le %):
            </label>
            <input
              type="number"
              className="form2"
          ...
          <div className="form-conso">
            <label htmlFor="Conso">
              Rentrez votre surface disponible pour implenter des panneaux
              photovoltaïques :
            </label>
            <input
              type="number"
